...
public class StringBasedFieldMappersTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void test_keyword_field_parser_on_mapping_with_length_limit() throws Exception {
        ...
        assertThat(actualMapping, is(
            "{\"default\":{\"properties\":" +
            "{\"text_col\":{\"type\":\"text\",\"index\":false,\"length_limit\":1}}}}"));
    }

    @Test
    public void test_text_field_parser_on_mapping_with_length_limit() throws Exception {
        String expectedMapping = Strings.toString(
            XContentFactory.jsonBuilder()
                .startObject()
                    .startObject(TYPE)
        ...
        assertThat(actualMapping, is(
            "{\"default\":{\"properties\":" +
            "{\"text_col\":{\"type\":\"text\",\"length_limit\":2}}}}"));
    }
}
